...
export default function EditCustomerModal({ open, customer, onClose, onSaved }: EditCustomerModalProps) {
      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-medium text-muted-foreground mb-1.5">
              {form.type === 'physical' ? 'Full Name *' : 'Contact Person *'}
            </label>
          ...
          {form.type === 'legal' && (
            <div>
              ...
              <input type="text" className={inputCls} value={form.company} onChange={(e) => set('company', e.target.value)} />
            </div>
          )}
          {form.type === 'physical' && (
            <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input type="text" className={inputCls} value={form.telegram} onChange={(e) => set('telegram', e.target.value)} />
          </div>
          <div>
