...
const initialOrders: SalesOrder[] = [
  { id: 'order-0241', orderNumber: 'ORD-0241', customer: 'Mirzo Ulugbek LLC', customerType: 'corporate', products: 'Hikvision DS-2CD2T47G2 ×4, Cable 100m', qty: 5, totalUZS: 18400000, paidUZS: 18400000, balanceUZS: 0, status: 'paid', paymentMethod: 'Bank Transfer', branch: 'Tashkent', date: '16.07.2026', dueDate: '16.07.2026', manager: 'Sardor Nazarov' },
  { id: 'order-0240', orderNumber: 'ORD-0240', customer: 'Jasur Xolmatov', customerType: 'individual', products: 'Dahua IPC-HDW2849H ×2, DVR-4108HS', qty: 3, totalUZS: 12750000, paidUZS: 6375000, balanceUZS: 6375000, status: 'partial', paymentMethod: 'Installment', branch: 'Tashkent', date: '16.07.2026', dueDate: '30.07.2026', manager: 'Malika Tursunova' },
  { id: 'order-0239', orderNumber: 'ORD-0239', customer: 'Baraka Savdo OOO', customerType: 'corporate', products: 'PTZ DS-2DE4A425IWG ×6, NVR', qty: 7, totalUZS: 34200000, paidUZS: 0, balanceUZS: 34200000, status: 'invoiced', paymentMethod: 'Bank Transfer', branch: 'Samarkand', date: '16.07.2026', dueDate: '23.07.2026', manager: 'Bobur Rahimov' },
  { id: 'order-0238', orderNumber: 'ORD-0238', customer: 'Dilnoza Yusupova', customerType: 'individual', products: 'Reolink RLC-810A ×3', qty: 3, totalUZS: 7800000, paidUZS: 7800000, balanceUZS: 0, status: 'paid', paymentMethod: 'Card', branch: 'Tashkent', date: '15.07.2026', dueDate: '15.07.2026', manager: 'Sardor Nazarov' },
  { id: 'order-0237', orderNumber: 'ORD-0237', customer: 'Ferghana Agro MCHJ', customerType: 'corporate', products: 'NVR DS-7608NI-K2, Camera ×8', qty: 9, totalUZS: 28500000, paidUZS: 14250000, balanceUZS: 14250000, status: 'confirmed', paymentMethod: 'Mixed', branch: 'Namangan', date: '15.07.2026', dueDate: '22.07.2026', manager: 'Umida Karimova' },
  { id: 'order-0236', orderNumber: 'ORD-0236', customer: 'Bobur Rahimov', customerType: 'individual', products: 'Hikvision DS-2CD2143G2 ×2', qty: 2, totalUZS: 9200000, paidUZS: 0, balanceUZS: 9200000, status: 'overdue', paymentMethod: 'Installment', branch: 'Tashkent', date: '10.07.2026', dueDate: '10.07.2026', manager: 'Malika Tursunova' },
  { id: 'order-0235', orderNumber: 'ORD-0235', customer: 'Navruz Qodirov', customerType: 'individual', products: 'RG59 Cable 500m, BNC ×100', qty: 2, totalUZS: 3150000, paidUZS: 3150000, balanceUZS: 0, status: 'paid', paymentMethod: 'Cash', branch: 'Tashkent', date: '14.07.2026', dueDate: '14.07.2026', manager: 'Sardor Nazarov' },
  { id: 'order-0234', orderNumber: 'ORD-0234', customer: 'Zulfiya Abdullayeva', customerType: 'individual', products: 'Dahua SD49425XB-HNR PTZ', qty: 1, totalUZS: 16900000, paidUZS: 0, balanceUZS: 16900000, status: 'cancelled', paymentMethod: 'Card', branch: 'Samarkand', date: '13.07.2026', dueDate: '13.07.2026', manager: 'Bobur Rahimov' },
  { id: 'order-0233', orderNumber: 'ORD-0233', customer: 'Toshkent Plaza JSCB', customerType: 'corporate', products: 'Full CCTV System 32ch', qty: 35, totalUZS: 148000000, paidUZS: 74000000, balanceUZS: 74000000, status: 'partial', paymentMethod: 'Bank Transfer', branch: 'Tashkent', date: '12.07.2026', dueDate: '26.07.2026', manager: 'Umida Karimova' },
  { id: 'order-0232', orderNumber: 'ORD-0232', customer: 'Kamol Yuldashev', customerType: 'individual', products: 'Hikvision DS-2CD2H47 ×4, DVR', qty: 5, totalUZS: 21600000, paidUZS: 21600000, balanceUZS: 0, status: 'paid', paymentMethod: 'Cash', branch: 'Andijan', date: '12.07.2026', dueDate: '12.07.2026', manager: 'Sardor Nazarov' },
  { id: 'order-0231', orderNumber: 'ORD-0231', customer: 'Sharq Savdo OOO', customerType: 'corporate', products: 'NVR DS-9632NI-I8 + 16 IP Cam', qty: 17, totalUZS: 87400000, paidUZS: 0, balanceUZS: 87400000, status: 'draft', paymentMethod: 'Bank Transfer', branch: 'Tashkent', date: '11.07.2026', dueDate: '18.07.2026', manager: 'Malika Tursunova' },
  { id: 'order-0230', orderNumber: 'ORD-0230', customer: 'Gulnora Mirzayeva', customerType: 'individual', products: 'Reolink Argus 3 Pro ×2', qty: 2, totalUZS: 4200000, paidUZS: 4200000, balanceUZS: 0, status: 'paid', paymentMethod: 'Card', branch: 'Tashkent', date: '11.07.2026', dueDate: '11.07.2026', manager: 'Sardor Nazarov' },
];
